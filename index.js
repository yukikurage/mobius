...
(function($PS) {
          ...
          return function (v1) {
              ...
              if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof SingularPoint) {
                  if (d instanceof Mobius_Game_Directions.Left) {
                      ...
                      var newMap = makeSingularPoint(v.value0)(v.value1 - 1 | 0)(updateSingularPoint(v.value0)(v.value1)(new Data_Tuple.Tuple(Empty.value, Empty.value))(swappedMap));
                      return newMap;
                  };
                  ...
                  if (d instanceof Mobius_Game_Directions.Up) {
                      return makeSingularPoint(v.value0 - 1 | 0)(v.value1)(updateSingularPoint(v.value0)(v.value1)(new Data_Tuple.Tuple(Empty.value, Empty.value))(v1));
                  };
  ...
  var index = function (v) {
      return function (v1) {
          var f = function (v2) {
              var $130 = Data_Eq.eq(Mobius_Game_Surface.eqSurface)(v1.value0)(Mobius_Game_Surface.Front.value);
              if ($130) {
                  return v2.value0;
              };
              return v2.value1;
      ...
      return function (v) {
          return function (v1) {
              return function (v2) {
                  ...
                  var newS = (function () {
                      var $157 = Data_Int.odd(isCrossBridge);
                      if ($157) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof Mobius_Game_Map2D.SingularPoint) {
                      ...
                      if (v3 instanceof Data_Maybe.Just && (v3.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && (v3.value0.value0.value0 instanceof Mobius_Game_Map2D.Empty && v3.value0.value0.value1 instanceof Mobius_Game_Map2D.Empty))) {
                          var newMap2D = Mobius_Game_Map2D.moveSingularPoint(nextPoint)(d)(v.value0.map2D);
                          return {
                              map2D: newMap2D,
                              character: v1.value0,
                              destinations: v.value0.destinations
      ...
      draw: function (ctx) {
          return function (images) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Mobius.Game.GameState (line 47, column 21 - line 49, column 51): " + [ v.constructor.name ]);
              };
          };
      }
  };
      ...
      if (v.value0 instanceof $$Map) {
          return function (v1) {
              if (v1 instanceof Move) {
                  return GameState.create($$Map.create(Mobius_Game_MapState.updateState(v.value0.value0)(new Mobius_Game_MapState.Move(v1.value0))));
              };
              if (v1 instanceof Z) {
                  return GameState.create($$Map.create(Mobius_Game_MapState.updateState(v.value0.value0)(Mobius_Game_MapState.Z.value)));
              };
              if (v1 instanceof R) {
                  return GameState.create($$Map.create(Mobius_Game_MapState.updateState(v.value0.value0)(Mobius_Game_MapState.R.value)));
              };
              throw new Error("Failed pattern match at Mobius.Game.GameState (line 22, column 39 - line 25, column 63): " + [ v1.constructor.name ]);
          };
      };
      if (v.value0 instanceof Menu) {
          return function (v1) {
              return GameState.create(Menu.value);
          };
      };
      throw new Error("Failed pattern match at Mobius.Game.GameState (line 21, column 1 - line 21, column 47): " + [ v.constructor.name ]);
  };
          ...
          return function (v1) {
              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Graphics_Canvas.getCanvasElementById("canvas")))(function (maybeCanvas) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                      ...
                      throw new Error("Failed pattern match at Mobius.WebApp.Components.GameCanvas (line 22, column 5 - line 29, column 27): " + [ maybeCanvas.constructor.name ]);
                  })())(function () {
