...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Directions"] = $PS["Mobius.Directions"] || {};
  var exports = $PS["Mobius.Directions"];
  var Up = (function () {
      function Up() {
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Surface"] = $PS["Mobius.Surface"] || {};
  var exports = $PS["Mobius.Surface"];
  var Front = (function () {
      function Front() {
  ...
  var showSurface = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Mobius.Surface (line 13, column 1 - line 15, column 21): " + [ v.constructor.name ]);
      }
  };
  var eqSurface = {
      eq: function (x) {
  ...
  var changeSurface = function (v) {
      ...
      throw new Error("Failed pattern match at Mobius.Surface (line 7, column 1 - line 7, column 36): " + [ v.constructor.name ]);
  };
  exports["Front"] = Front;
  exports["changeSurface"] = changeSurface;
  exports["eqSurface"] = eqSurface;
  exports["showSurface"] = showSurface;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.LatticePoint"] = $PS["Mobius.LatticePoint"] || {};
  var exports = $PS["Mobius.LatticePoint"];
  var Data_Show = $PS["Data.Show"];
  var Mobius_Surface = $PS["Mobius.Surface"];                
  ...
  var showLatticePoint = {
      show: function (v) {
          return "LatticePoint " + (Data_Show.show(Mobius_Surface.showSurface)(v.value0) + (" " + (Data_Show.show(Data_Show.showInt)(v.value1) + (" " + Data_Show.show(Data_Show.showInt)(v.value2)))));
      }
  };
  exports["LatticePoint"] = LatticePoint;
  exports["showLatticePoint"] = showLatticePoint;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Map2D"] = $PS["Mobius.Map2D"] || {};
  var exports = $PS["Mobius.Map2D"];
  ...
  var Data_Tuple = $PS["Data.Tuple"];
  var Matrix = $PS["Matrix"];
  var Mobius_Directions = $PS["Mobius.Directions"];
  var Mobius_LatticePoint = $PS["Mobius.LatticePoint"];
  var Mobius_Surface = $PS["Mobius.Surface"];                
  ...
  var showWithSingularPoint = function (dictShow) {
      return {
          show: function (v) {
              ...
              throw new Error("Failed pattern match at Mobius.Map2D (line 33, column 10 - line 35, column 33): " + [ v.constructor.name ]);
          }
      };
  };
  var showCell = function (dictShow) {
      return {
          show: function (v) {
              ...
              throw new Error("Failed pattern match at Mobius.Map2D (line 23, column 10 - line 25, column 23): " + [ v.constructor.name ]);
          }
      };
  };
  var functorWithSingularPoint = {
      map: function (f) {
          return function (m) {
              ...
              throw new Error("Failed pattern match at Mobius.Map2D (line 30, column 1 - line 30, column 42): " + [ m.constructor.name ]);
          };
      }
  };
  var showMap2D = function (dictShow) {
      return {
          show: function (v) {
              var front = Data_Functor.map(Matrix.functorMatrix)(Data_Functor.map(functorWithSingularPoint)(Data_Tuple.fst))(v.value0);
              var deleteComma = Data_String_Common.replaceAll(",")("");
              var back = Data_Functor.map(Matrix.functorMatrix)(Data_Functor.map(functorWithSingularPoint)(Data_Tuple.snd))(v.value0);
              return deleteComma(Data_Show.show(Matrix.showMatrix(showWithSingularPoint(dictShow)))(front)) + ("\x0a\x0a" + (deleteComma(Data_Show.show(Matrix.showMatrix(showWithSingularPoint(dictShow)))(back)) + "\x0a"));
          }
      };
  };
              ...
              var f = function (v2) {
                  ...
                  if (v2 instanceof NotSingularPoint) {
                      return NotSingularPoint.create((function () {
                          var $72 = Data_Eq.eq(Mobius_Surface.eqSurface)(v.value0)(Mobius_Surface.Front.value);
                          if ($72) {
                  ...
                  throw new Error("Failed pattern match at Mobius.Map2D (line 81, column 3 - line 81, column 34): " + [ v2.constructor.name ]);
              };
  ...
  var index = function (v) {
      return function (v1) {
          var f = function (v2) {
              var $87 = Data_Eq.eq(Mobius_Surface.eqSurface)(v1.value0)(Mobius_Surface.Front.value);
              if ($87) {
                  return v2.value0;
              };
              return v2.value1;
      ...
      return function (v) {
          return function (v1) {
              return function (v2) {
                  ...
                  if (v2 instanceof Mobius_Directions.Change) {
                      return Data_Maybe.Just.create(new Mobius_LatticePoint.LatticePoint(Mobius_Surface.changeSurface(v1.value0), v1.value1, v1.value2));
                  };
                  var newJ = (function () {
                      if (v2 instanceof Mobius_Directions.Right) {
                          return v1.value2 + 1 | 0;
                      };
                      if (v2 instanceof Mobius_Directions.Left) {
                          return v1.value2 - 1 | 0;
                      };
                      return v1.value2;
                  })();
                  var newI = (function () {
                      if (v2 instanceof Mobius_Directions.Up) {
                          return v1.value1 - 1 | 0;
                      };
                      if (v2 instanceof Mobius_Directions.Down) {
                          return v1.value1 + 1 | 0;
                      };
                      return v1.value1;
                  })();
                  var isCrossBridge = (function () {
                      if (v2 instanceof Mobius_Directions.Left) {
                          return Data_Array.length(Data_Array.filter(function (k) {
                              return Data_Eq.eq(Data_Maybe.eqMaybe(eqWithSingularPoint(dictEq)))(index(v)(new Mobius_LatticePoint.LatticePoint(v1.value0, k, v1.value2)))(new Data_Maybe.Just(SingularPoint.value));
                          })(Common.upRange(0)(v1.value1)));
                      };
                      if (v2 instanceof Mobius_Directions.Right) {
                          return Data_Array.length(Data_Array.filter(function (k) {
                              return Data_Eq.eq(Data_Maybe.eqMaybe(eqWithSingularPoint(dictEq)))(index(v)(new Mobius_LatticePoint.LatticePoint(v1.value0, k, v1.value2 + 1 | 0)))(new Data_Maybe.Just(SingularPoint.value));
                          })(Common.upRange(0)(v1.value1)));
                      };
                      return 0;
                  })();
                  var newS = (function () {
                      var $109 = Data_Int.odd(isCrossBridge);
                      if ($109) {
                          return Mobius_Surface.changeSurface(v1.value0);
                      };
                      return v1.value0;
                  })();
                  return Data_Maybe.Just.create(new Mobius_LatticePoint.LatticePoint(newS, newI, newJ));
              };
          };
      };
  };
  ...
  exports["showMap2D"] = showMap2D;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Object"] = $PS["Mobius.Object"] || {};
  var exports = $PS["Mobius.Object"];
  var Push = (function () {
      function Push() {
  ...
  var showObject = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Mobius.Object (line 16, column 10 - line 19, column 15): " + [ v.constructor.name ]);
      }
  };
  var eqObject = {
      eq: function (x) {
  ...
  var objectProperty = function (v) {
      ...
      throw new Error("Failed pattern match at Mobius.Object (line 22, column 18 - line 25, column 14): " + [ v.constructor.name ]);
  };
  exports["Wall"] = Wall;
  exports["Apple"] = Apple;
  exports["Box"] = Box;
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.MapState"] = $PS["Mobius.MapState"] || {};
  var exports = $PS["Mobius.MapState"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Show = $PS["Data.Show"];
  var Mobius_LatticePoint = $PS["Mobius.LatticePoint"];
  var Mobius_Map2D = $PS["Mobius.Map2D"];
  var Mobius_Object = $PS["Mobius.Object"];                
  ...
  var showMapState = {
      show: function (v) {
          return "MapState{\x0a" + (Data_Show.show(Mobius_Map2D.showMap2D(Mobius_Map2D.showCell(Mobius_Object.showObject)))(v.value0.map2D) + (",\x0acharacter:" + (Data_Show.show(Mobius_LatticePoint.showLatticePoint)(v.value0.character) + (",\x0adestinations:\x0a" + (Data_Show.show(Mobius_Map2D.showMap2D(Data_Show.showBoolean))(v.value0.destinations) + "\x0a}")))));
      }
  };
  var move = function (v) {
      return function (d) {
          return MapState.create((function () {
              var v1 = Mobius_Map2D.compute(Mobius_Map2D.eqCell(Mobius_Object.eqObject))(v.value0.map2D)(v.value0.character)(d);
              if (v1 instanceof Data_Maybe.Nothing) {
                  return {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  var v2 = Mobius_Map2D.index(v.value0.map2D)(v1.value0);
                  if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof Mobius_Map2D.SingularPoint) {
                      return {
                          map2D: v.value0.map2D,
                          character: v.value0.character,
                          destinations: v.value0.destinations
                  ...
                  if (v2 instanceof Data_Maybe.Just && (v2.value0 instanceof Mobius_Map2D.NotSingularPoint && v2.value0.value0 instanceof Mobius_Map2D.Empty)) {
                      return {
                          map2D: v.value0.map2D,
                          character: v1.value0,
                          destinations: v.value0.destinations
                  ...
                  if (v2 instanceof Data_Maybe.Just && (v2.value0 instanceof Mobius_Map2D.NotSingularPoint && v2.value0.value0 instanceof Mobius_Map2D["Object"])) {
                      var v3 = Mobius_Object.objectProperty(v2.value0.value0.value0);
                      if (v3 instanceof Mobius_Object.Stop) {
                          return {
                              map2D: v.value0.map2D,
                              character: v.value0.character,
                              destinations: v.value0.destinations
                      ...
                      if (v3 instanceof Mobius_Object.Push) {
                          var v4 = Mobius_Map2D.compute(Mobius_Map2D.eqCell(Mobius_Object.eqObject))(v.value0.map2D)(v1.value0)(d);
                          ...
                          if (v4 instanceof Data_Maybe.Just) {
                              var v5 = Mobius_Map2D.index(v.value0.map2D)(v4.value0);
                              if (v5 instanceof Data_Maybe.Just && (v5.value0 instanceof Mobius_Map2D.NotSingularPoint && v5.value0.value0 instanceof Mobius_Map2D.Empty)) {
                                  var newMap2D = Mobius_Map2D.updateAt(v4.value0)(new Mobius_Map2D["Object"](v2.value0.value0.value0))(Mobius_Map2D.updateAt(v1.value0)(Mobius_Map2D.Empty.value)(v.value0.map2D));
                                  return {
                                      map2D: newMap2D,
                                      character: v1.value0,
                                      destinations: v.value0.destinations
                          ...
                          throw new Error("Failed pattern match at Mobius.MapState (line 35, column 15 - line 42, column 50): " + [ v4.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Mobius.MapState (line 33, column 43 - line 42, column 50): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return {
                          map2D: v.value0.map2D,
                  ...
                  throw new Error("Failed pattern match at Mobius.MapState (line 29, column 19 - line 43, column 50): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Mobius.MapState (line 27, column 67 - line 43, column 50): " + [ v1.constructor.name ]);
          })());
      };
  };
  exports["MapState"] = MapState;
  exports["move"] = move;
  exports["showMapState"] = showMapState;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  ...
  var makeText = function (str) {
      return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidArray)(Data_Array.singleton(Halogen_HTML_Elements.br_))(Data_Functor.map(Data_Functor.functorArray)(function ($0) {
          return Data_Array.singleton(Halogen_HTML_Core.text($0));
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.WebApp.Components.TestPlay"] = $PS["Mobius.WebApp.Components.TestPlay"] || {};
  var exports = $PS["Mobius.WebApp.Components.TestPlay"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Mobius_LatticePoint = $PS["Mobius.LatticePoint"];
  var Mobius_Map2D = $PS["Mobius.Map2D"];
  var Mobius_MapState = $PS["Mobius.MapState"];
  var Mobius_Object = $PS["Mobius.Object"];
  var Mobius_Surface = $PS["Mobius.Surface"];
  ...
  var w = new Mobius_Map2D["Object"](Mobius_Object.Wall.value);
  var testDestinations = Mobius_Map2D.Map2D.create(Matrix.empty);
  var e = Mobius_Map2D.Empty.value;
  var b = new Mobius_Map2D["Object"](Mobius_Object.Box.value);
  var testBackMap = Data_Maybe.fromMaybe(Matrix.empty)(Matrix.fromArray([ [ e, w, e, e, e ], [ b, b, e, e, e ], [ e, e, e, e, e ], [ e, e, e, e, e ], [ e, e, e, e, e ] ]));
  var a = new Mobius_Map2D["Object"](Mobius_Object.Apple.value);
  var testFrontMap = Data_Maybe.fromMaybe(Matrix.empty)(Matrix.fromArray([ [ e, e, e, e, e ], [ e, e, e, b, w ], [ e, e, e, e, e ], [ e, a, e, e, e ], [ e, e, e, e, e ] ]));
  var testMap2D = Mobius_Map2D.Map2D.create(Data_Maybe.fromMaybe(Matrix.empty)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Matrix.set(2)(2)(Mobius_Map2D.SingularPoint.value))(Matrix.zipWith(function (x) {
      return function (y) {
          return new Mobius_Map2D.NotSingularPoint(new Data_Tuple.Tuple(x, y));
      };
  })(testFrontMap)(testBackMap))));
  var testMapState = new Mobius_MapState.MapState({
      character: new Mobius_LatticePoint.LatticePoint(Mobius_Surface.Front.value, 0, 0),
  ...
  var component = function (dictMonad) {
      return function (dictMonadEffect) {
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(testMapState))(function (v2) {
                      var keyDownHandler = function (e1) {
                          var dir = (function () {
                              var v3 = Web_UIEvent_KeyboardEvent.key(e1);
                              if (v3 === "w") {
                                  return new Data_Maybe.Just(Mobius_Directions.Up.value);
                              };
                              if (v3 === "d") {
                                  return new Data_Maybe.Just(Mobius_Directions.Right.value);
                              };
                              if (v3 === "s") {
                                  return new Data_Maybe.Just(Mobius_Directions.Down.value);
                              };
                              if (v3 === "a") {
                                  return new Data_Maybe.Just(Mobius_Directions.Left.value);
                              };
                              return Data_Maybe.Nothing.value;
                          })();
                          var newMapState = Data_Maybe.fromMaybe(v2.value0)(Data_Functor.map(Data_Maybe.functorMaybe)(Mobius_MapState.move(v2.value0))(dir));
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(newMapState))(function () {
                              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Unit.unit);
                          });
                      };
                      return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.button([ Mobius_WebApp_Components_Common.css("h-screen w-screen m-9"), Halogen_HTML_Events.onKeyDown(keyDownHandler) ])(Mobius_WebApp_Components_Common.makeText(Data_Show.show(Mobius_MapState.showMapState)(v2.value0))));
                  });
              };
          });
      };
...
(function($PS) {
  ...
  var Mobius_WebApp_Components_TestPlay = $PS["Mobius.WebApp.Components.TestPlay"];                
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("body"))(function (bodyElem) {
          return Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(Mobius_WebApp_Components_TestPlay.component(Effect_Aff.monadAff)(Effect_Aff.monadEffectAff))(Data_Unit.unit))(bodyElem);
      });
  }));
  exports["main"] = main;
})(PS);
