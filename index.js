...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["WebApp.Components.Common"] = $PS["WebApp.Components.Common"] || {};
  var exports = $PS["WebApp.Components.Common"];
  var Data_Array = $PS["Data.Array"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Monoid = $PS["Data.Monoid"];
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["WebApp.Components.TestPlay"] = $PS["WebApp.Components.TestPlay"] || {};
  var exports = $PS["WebApp.Components.TestPlay"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var WebApp_Components_Common = $PS["WebApp.Components.Common"];                
          ...
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(testMapState))(function (v2) {
                      ...
                      return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.button([ WebApp_Components_Common.css("h-screen w-screen m-9"), Halogen_HTML_Events.onKeyDown(keyDownHandler) ])(WebApp_Components_Common.makeText(Data_Show.show(Mobius_MapState.showMapState)(v2.value0))));
                  });
              };
          });
      };
...
(function($PS) {
  ...
  var WebApp_Components_TestPlay = $PS["WebApp.Components.TestPlay"];                
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("body"))(function (bodyElem) {
          return Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(WebApp_Components_TestPlay.component(Effect_Aff.monadAff)(Effect_Aff.monadEffectAff))(Data_Unit.unit))(bodyElem);
      });
  }));
  exports["main"] = main;
})(PS);
