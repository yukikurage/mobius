...
(function($PS) {
  ...
  var upRange = function (x) {
      return function (y) {
          ...
          throw new Error("Failed pattern match at Common (line 13, column 1 - line 13, column 35): " + [ x.constructor.name, y.constructor.name ]);
      };
  };
  var set = function (x) {
      return function (y) {
          return Matrix.set(y)(x);
      };
  };
  var modify = function (x) {
      return function (y) {
          return Matrix.modify(y)(x);
      };
  };
  var get = function (x) {
      return function (y) {
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.Drawable"] = $PS["Mobius.Game.Drawable"] || {};
  var exports = $PS["Mobius.Game.Drawable"];
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.GameManager"] = $PS["Mobius.Game.GameManager"] || {};
  var exports = $PS["Mobius.Game.GameManager"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  ...
  var KeyInput = (function () {
      function KeyInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      KeyInput.create = function (value0) {
          return function (value1) {
              return new KeyInput(value0, value1);
          };
      };
      return KeyInput;
  })();
  var runGame = function (v) {
      var mainLoop = function (ctx) {
          return function (imageSources) {
              return function (gameStateRef) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(gameStateRef)))(function (gameState) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(Data_Time_Duration.Milliseconds(1000.0 / Data_Int.toNumber(v.fps))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Graphics_Canvas.clearRect(ctx)({
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(v.render(ctx)(function (s) {
                                  return Data_Map_Internal.lookup(Data_Ord.ordString)(s)(imageSources);
                              })(gameState)))(function () {
                                  return mainLoop(ctx)(imageSources)(gameStateRef);
                              });
                          });
                      });
                  });
      ...
      var keyEventRegister = function (gameStateRef) {
          return function __do() {
              var w = Web_HTML.window();
              var makeHandler = function (x) {
                  return Web_Event_EventTarget.eventListener(function (e) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return function __do() {
                              var gameState = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Effect_Ref.read(gameStateRef))();
                              var newGameState = v.keyHandler(new KeyInput(Web_UIEvent_KeyboardEvent.key(v1.value0), x))(gameState);
              ...
              var keyPressHandler = makeHandler(KeyPress.value)();
              var keyUpHandler = makeHandler(KeyUp.value)();
              Web_Event_EventTarget.addEventListener("keydown")(keyDownHandler)(false)(Web_HTML_Window.toEventTarget(w))();
              Web_Event_EventTarget.addEventListener("keypress")(keyPressHandler)(false)(Web_HTML_Window.toEventTarget(w))();
              return Web_Event_EventTarget.addEventListener("keyup")(keyUpHandler)(false)(Web_HTML_Window.toEventTarget(w))();
          };
      };
      var loadAndRun = function (xs) {
          return function (imageSources) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                  return function __do() {
                      ...
                      var gameStateRef = Effect_Ref["new"](v.initState)();
                      Effect_Aff.runAff_(function (v2) {
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.Directions"] = $PS["Mobius.Game.Directions"] || {};
  var exports = $PS["Mobius.Game.Directions"];
  var Up = (function () {
      function Up() {
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.LatticePoint"] = $PS["Mobius.Game.LatticePoint"] || {};
  var exports = $PS["Mobius.Game.LatticePoint"];
  ...
  var LatticePoint = (function () {
      function LatticePoint(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      LatticePoint.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new LatticePoint(value0, value1, value2);
              };
          };
      };
      return LatticePoint;
  ...
  var toPoint = function (v) {
      return new Point(v.value1, v.value2);
  };
  var fromPoint = function (s) {
      return function (v) {
          return new LatticePoint(s, v.value0, v.value1);
      };
  };
  var computeWithPoint = function (v) {
      return function (v1) {
          if (v1 instanceof Mobius_Game_Directions.Up) {
              return new Point(v.value0 - 1 | 0, v.value1);
          };
          if (v1 instanceof Mobius_Game_Directions.Down) {
              return new Point(v.value0 + 1 | 0, v.value1);
          };
          if (v1 instanceof Mobius_Game_Directions.Right) {
              return Point.create(v.value0)(v.value1 + 1 | 0);
          };
          if (v1 instanceof Mobius_Game_Directions.Left) {
              return Point.create(v.value0)(v.value1 - 1 | 0);
          };
          if (v1 instanceof Mobius_Game_Directions.Change) {
              return new Point(v.value0, v.value1);
          };
          throw new Error("Failed pattern match at Mobius.Game.LatticePoint (line 22, column 32 - line 27, column 22): " + [ v1.constructor.name ]);
      };
  };
  exports["LatticePoint"] = LatticePoint;
  exports["Point"] = Point;
  exports["toPoint"] = toPoint;
  exports["fromPoint"] = fromPoint;
  exports["computeWithPoint"] = computeWithPoint;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.Surface"] = $PS["Mobius.Game.Surface"] || {};
  var exports = $PS["Mobius.Game.Surface"];
  var Front = (function () {
      function Front() {
  ...
  var changeSurface = function (v) {
      if (v instanceof Front) {
          return Back.value;
      };
      if (v instanceof Back) {
          return Front.value;
      };
      throw new Error("Failed pattern match at Mobius.Game.Surface (line 7, column 1 - line 7, column 36): " + [ v.constructor.name ]);
  };
  exports["Front"] = Front;
  exports["Back"] = Back;
  exports["changeSurface"] = changeSurface;
  exports["eqSurface"] = eqSurface;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  ...
  var Mobius_Game_Surface = $PS["Mobius.Game.Surface"];                
  var SingularPoint = (function () {
      function SingularPoint() {

      };
      SingularPoint.value = new SingularPoint();
      return SingularPoint;
  })();
  var NotSingularPoint = (function () {
      function NotSingularPoint(value0) {
          this.value0 = value0;
      };
      NotSingularPoint.create = function (value0) {
          return new NotSingularPoint(value0);
      };
      return NotSingularPoint;
  })();
  var Map2D = (function () {
      function Map2D(value0) {
          this.value0 = value0;
      };
      Map2D.create = function (value0) {
          return new Map2D(value0);
      };
      return Map2D;
  })();
  var Empty = (function () {
  ...
  var functorWithSingularPoint = {
      map: function (f) {
          return function (m) {
              if (m instanceof SingularPoint) {
                  return SingularPoint.value;
              };
              if (m instanceof NotSingularPoint) {
                  return new NotSingularPoint(f(m.value0));
              };
              throw new Error("Failed pattern match at Mobius.Game.Map2D (line 37, column 1 - line 37, column 42): " + [ m.constructor.name ]);
          };
      }
  };
  var eqWithSingularPoint = function (dictEq) {
      return {
          eq: function (x) {
              return function (y) {
                  if (x instanceof SingularPoint && y instanceof SingularPoint) {
                      return true;
                  };
                  if (x instanceof NotSingularPoint && y instanceof NotSingularPoint) {
                      return Data_Eq.eq(dictEq)(x.value0)(y.value0);
                  };
                  return false;
              };
  ...
  var drawableWithSingularPoint = function (dictDrawable) {
      return {
          draw: function (ctx) {
              return function (images) {
                  return function (v) {
                      if (v instanceof SingularPoint) {
                          return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("mobius");
                      };
                      if (v instanceof NotSingularPoint) {
                          return Mobius_Game_Drawable.draw(dictDrawable)(ctx)(images)(v.value0);
                      };
                      throw new Error("Failed pattern match at Mobius.Game.Map2D (line 45, column 21 - line 47, column 44): " + [ v.constructor.name ]);
                  };
              };
          }
      };
  };
  var drawableCell = function (dictDrawable) {
      return {
          draw: function (ctx) {
              return function (images) {
                  return function (v) {
                      ...
                      throw new Error("Failed pattern match at Mobius.Game.Map2D (line 30, column 21 - line 32, column 34): " + [ v.constructor.name ]);
                  };
              };
          }
      };
  };
  var widthMap2D = function (v) {
      return Matrix.width(v.value0);
  };
  var updateSingularPoint = function (i) {
      return function (j) {
          return function (x) {
              return function (v) {
                  var f = function (v1) {
                      if (v1 instanceof SingularPoint) {
                          return new NotSingularPoint(x);
                      };
                      return v1;
                  };
                  return Map2D.create(Data_Maybe.fromMaybe(v.value0)(Common.modify(i)(j)(f)(v.value0)));
              };
          };
      };
  };
  var updateAt = function (v) {
      return function (x) {
          return function (v1) {
              var f = function (v2) {
                  if (v2 instanceof SingularPoint) {
                      return SingularPoint.value;
                  };
                  if (v2 instanceof NotSingularPoint) {
                      return NotSingularPoint.create((function () {
                          var $93 = Data_Eq.eq(Mobius_Game_Surface.eqSurface)(v.value0)(Mobius_Game_Surface.Front.value);
                          if ($93) {
                              return new Data_Tuple.Tuple(x, v2.value0.value1);
                          };
                          return new Data_Tuple.Tuple(v2.value0.value0, x);
                      })());
                  };
                  throw new Error("Failed pattern match at Mobius.Game.Map2D (line 100, column 3 - line 100, column 34): " + [ v2.constructor.name ]);
              };
              return Map2D.create(Data_Maybe.fromMaybe(v1.value0)(Common.modify(v.value1)(v.value2)(f)(v1.value0)));
          };
      };
  };
  var makeSingularPoint = function (i) {
      return function (j) {
          return function (v) {
              return Map2D.create(Data_Maybe.fromMaybe(v.value0)(Common.set(i)(j)(SingularPoint.value)(v.value0)));
          };
      };
  };
  var indexWithPoint = function (v) {
      return function (v1) {
          return Common.get(v1.value0)(v1.value1)(v.value0);
      };
  };
  var moveSingularPoint = function (v) {
      return function (d) {
          return function (emp) {
              return function (v1) {
                  var v2 = indexWithPoint(v1)(new Mobius_Game_LatticePoint.Point(v.value0, v.value1));
                  if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof SingularPoint) {
                      if (d instanceof Mobius_Game_Directions.Left) {
                          var f = function (v3) {
                              if (v3 instanceof SingularPoint) {
                                  return SingularPoint.value;
                              };
                              if (v3 instanceof NotSingularPoint) {
                                  return NotSingularPoint.create(new Data_Tuple.Tuple(v3.value0.value1, v3.value0.value0));
                              };
                              throw new Error("Failed pattern match at Mobius.Game.Map2D (line 122, column 7 - line 122, column 38): " + [ v3.constructor.name ]);
                          };
                          var swappedMap = Map2D.create(Data_Array.foldl(function (acc) {
                              return function (k) {
                                  return Data_Maybe.fromMaybe(acc)(Common.modify(k)(v.value1 - 1 | 0)(f)(acc));
                              };
                          })(v1.value0)(Common.upRange(v.value0 + 1 | 0)(Matrix.height(v1.value0))));
                          var newMap = makeSingularPoint(v.value0)(v.value1 - 1 | 0)(updateSingularPoint(v.value0)(v.value1)(new Data_Tuple.Tuple(emp, emp))(swappedMap));
                          return newMap;
                      };
                      if (d instanceof Mobius_Game_Directions.Right) {
                          var f = function (v3) {
                              if (v3 instanceof SingularPoint) {
                                  return SingularPoint.value;
                              };
                              ...
                              throw new Error("Failed pattern match at Mobius.Game.Map2D (line 128, column 7 - line 128, column 38): " + [ v3.constructor.name ]);
                          };
                          var swappedMap = Map2D.create(Data_Array.foldl(function (acc) {
                              return function (k) {
                                  return Data_Maybe.fromMaybe(acc)(Common.modify(k)(v.value1)(f)(acc));
                              };
                          })(v1.value0)(Common.upRange(v.value0 + 1 | 0)(Matrix.height(v1.value0))));
                          var newMap = makeSingularPoint(v.value0)(v.value1 + 1 | 0)(updateSingularPoint(v.value0)(v.value1)(new Data_Tuple.Tuple(emp, emp))(swappedMap));
                          return newMap;
                      };
                      if (d instanceof Mobius_Game_Directions.Up) {
                          return makeSingularPoint(v.value0 - 1 | 0)(v.value1)(updateSingularPoint(v.value0)(v.value1)(new Data_Tuple.Tuple(emp, emp))(v1));
                      };
                      if (d instanceof Mobius_Game_Directions.Down) {
                          return makeSingularPoint(v.value0 + 1 | 0)(v.value1)(updateSingularPoint(v.value0)(v.value1)(new Data_Tuple.Tuple(emp, emp))(v1));
                      };
                      if (d instanceof Mobius_Game_Directions.Change) {
                          return v1;
                      };
                      throw new Error("Failed pattern match at Mobius.Game.Map2D (line 118, column 25 - line 133, column 20): " + [ d.constructor.name ]);
                  };
                  return v1;
              };
          };
  ...
  var index = function (v) {
      return function (v1) {
          var f = function (v2) {
              var $131 = Data_Eq.eq(Mobius_Game_Surface.eqSurface)(v1.value0)(Mobius_Game_Surface.Front.value);
              if ($131) {
                  return v2.value0;
              };
              return v2.value1;
          };
          return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(functorWithSingularPoint)(f))(Common.get(v1.value1)(v1.value2)(v.value0));
      };
  };
  var heightMap2D = function (v) {
      return Matrix.height(v.value0);
  };
  var compute = function (dictEq) {
      return function (v) {
          return function (v1) {
              return function (v2) {
                  if (Data_Eq.eq(Data_Maybe.eqMaybe(eqWithSingularPoint(dictEq)))(index(v)(v1))(new Data_Maybe.Just(SingularPoint.value))) {
                      return Data_Maybe.Nothing.value;
                  };
                  if (v2 instanceof Mobius_Game_Directions.Change) {
                      return Data_Maybe.Just.create(new Mobius_Game_LatticePoint.LatticePoint(Mobius_Game_Surface.changeSurface(v1.value0), v1.value1, v1.value2));
                  };
                  if (Data_Eq.eq(Data_Maybe.eqMaybe(eqWithSingularPoint(Data_Tuple.eqTuple(dictEq)(dictEq))))(indexWithPoint(v)(Mobius_Game_LatticePoint.computeWithPoint(Mobius_Game_LatticePoint.toPoint(v1))(v2)))(new Data_Maybe.Just(SingularPoint.value))) {
                      var computedPoint = Mobius_Game_LatticePoint.computeWithPoint(Mobius_Game_LatticePoint.toPoint(v1))(v2);
                      return Data_Maybe.Just.create(Mobius_Game_LatticePoint.fromPoint(v1.value0)(computedPoint));
                  };
                  var newJ = (function () {
                      if (v2 instanceof Mobius_Game_Directions.Right) {
                          return v1.value2 + 1 | 0;
                      };
                      if (v2 instanceof Mobius_Game_Directions.Left) {
                          return v1.value2 - 1 | 0;
                      };
                      return v1.value2;
                  })();
                  var newI = (function () {
                      if (v2 instanceof Mobius_Game_Directions.Up) {
                          return v1.value1 - 1 | 0;
                      };
                      if (v2 instanceof Mobius_Game_Directions.Down) {
                          return v1.value1 + 1 | 0;
                      };
                      return v1.value1;
                  })();
                  var isCrossBridge = (function () {
                      if (v2 instanceof Mobius_Game_Directions.Left) {
                          return Data_Array.length(Data_Array.filter(function (k) {
                              return Data_Eq.eq(Data_Maybe.eqMaybe(eqWithSingularPoint(dictEq)))(index(v)(new Mobius_Game_LatticePoint.LatticePoint(v1.value0, k, v1.value2)))(new Data_Maybe.Just(SingularPoint.value));
                          })(Common.upRange(0)(v1.value1)));
                      };
                      if (v2 instanceof Mobius_Game_Directions.Right) {
                          return Data_Array.length(Data_Array.filter(function (k) {
                              return Data_Eq.eq(Data_Maybe.eqMaybe(eqWithSingularPoint(dictEq)))(index(v)(new Mobius_Game_LatticePoint.LatticePoint(v1.value0, k, v1.value2 + 1 | 0)))(new Data_Maybe.Just(SingularPoint.value));
                          })(Common.upRange(0)(v1.value1)));
                      };
                      return 0;
                  })();
                  var newS = (function () {
                      var $158 = Data_Int.odd(isCrossBridge);
                      if ($158) {
                          return Mobius_Game_Surface.changeSurface(v1.value0);
                      };
                      return v1.value0;
                  })();
                  return Data_Maybe.Just.create(new Mobius_Game_LatticePoint.LatticePoint(newS, newI, newJ));
              };
          };
      };
  };
  ...
  exports["SingularPoint"] = SingularPoint;
  exports["NotSingularPoint"] = NotSingularPoint;
  exports["Map2D"] = Map2D;
  exports["indexWithPoint"] = indexWithPoint;
  exports["index"] = index;
  exports["compute"] = compute;
  exports["updateAt"] = updateAt;
  exports["moveSingularPoint"] = moveSingularPoint;
  exports["heightMap2D"] = heightMap2D;
  exports["widthMap2D"] = widthMap2D;
  exports["eqCell"] = eqCell;
  exports["drawableCell"] = drawableCell;
  exports["eqWithSingularPoint"] = eqWithSingularPoint;
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.Object"] = $PS["Mobius.Game.Object"] || {};
  var exports = $PS["Mobius.Game.Object"];
  var Mobius_Game_Common = $PS["Mobius.Game.Common"];                
  var Push = (function () {
      function Push() {
  ...
  var eqObject = {
      eq: function (x) {
          return function (y) {
              if (x instanceof Wall && y instanceof Wall) {
                  return true;
              };
          ...
          return function (images) {
              return function (v) {
                  if (v instanceof Wall) {
                      return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("wall");
                  };
                  if (v instanceof Apple) {
                      return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("apple");
                  };
                  if (v instanceof Box) {
                      return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("box");
                  };
                  throw new Error("Failed pattern match at Mobius.Game.Object (line 25, column 21 - line 28, column 49): " + [ v.constructor.name ]);
              };
          };
      }
  };
  var objectProperty = function (v) {
      if (v instanceof Wall) {
          return Stop.value;
      };
      if (v instanceof Apple) {
      ...
      throw new Error("Failed pattern match at Mobius.Game.Object (line 31, column 18 - line 34, column 14): " + [ v.constructor.name ]);
  };
  exports["Wall"] = Wall;
  exports["Apple"] = Apple;
  exports["Box"] = Box;
...
(function($PS) {
  ...
  var Mobius_Game_Surface = $PS["Mobius.Game.Surface"];                
  var MapEnv = (function () {
      function MapEnv(value0) {
          this.value0 = value0;
      };
      MapEnv.create = function (value0) {
          return new MapEnv(value0);
      };
      return MapEnv;
  })();
  var MapState = (function () {
      function MapState(value0) {
          this.value0 = value0;
      };
      MapState.create = function (value0) {
          return new MapState(value0);
      };
      return MapState;
  })();
  var Move = (function () {
              ...
              return function (v) {
                  ...
                  return function __do() {
                      ...
                      Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Common.upRange(0)(h - 1 | 0))(function (i) {
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Common.upRange(0)(w - 1 | 0))(function (j) {
                              return function __do() {
                                  ...
                                  (function () {
                                      var v1 = Mobius_Game_Map2D.index(v.value0.mapEnv.value0.destinations)(new Mobius_Game_LatticePoint.LatticePoint(Mobius_Game_Surface.Front.value, i, j));
                                      if (v1 instanceof Data_Maybe.Just && (v1.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && v1.value0.value0)) {
                                          return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("destination")();
                                      };
                          ...
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Common.upRange(0)(w - 1 | 0))(function (j) {
                              return function __do() {
                                  ...
                                  (function () {
                                      ...
                                      if (v1 instanceof Data_Maybe.Just) {
                                          return Mobius_Game_Drawable.draw(Mobius_Game_Map2D.drawableWithSingularPoint(Mobius_Game_Map2D.drawableCell(Mobius_Game_Object.drawableObject)))(ctx)(images)(v1.value0)();
                                      };
                                      if (v1 instanceof Data_Maybe.Nothing) {
                                          return Data_Unit.unit;
                                      };
                                      throw new Error("Failed pattern match at Mobius.Game.MapState (line 179, column 7 - line 181, column 29): " + [ v1.constructor.name ]);
                                  })();
                                  return Mobius_Game_Common.resetTransForm(ctx)();
                              };
                          });
                          ...
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Common.upRange(0)(w - 1 | 0))(function (j) {
                              return function __do() {
                                  ...
                                  (function () {
                                      ...
                                      throw new Error("Failed pattern match at Mobius.Game.MapState (line 191, column 7 - line 193, column 29): " + [ v1.constructor.name ]);
                                  })();
                                  return Mobius_Game_Common.resetTransForm(ctx)();
                              };
                          });
                      ...
                      (function () {
                          ...
                          throw new Error("Failed pattern match at Mobius.Game.MapState (line 198, column 5 - line 212, column 27): " + [ v.value0.mapEnv.value0.character.constructor.name ]);
                      })();
                      Data_Unit.unit;
                      ...
                      Graphics_Canvas.setGlobalCompositeOperation(ctx)(Graphics_Canvas.DestinationOver.value)();
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Common.upRange(0)(h - 1 | 0))(function (i) {
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Common.upRange(0)(w - 1 | 0))(function (j) {
                              return function __do() {
                                  Graphics_Canvas.translate(ctx)({
                                      translateX: startWidth + Data_Int.toNumber(j) * Mobius_Game_GameSettings.cellSize,
                                  ...
                                  (function () {
                                      var v1 = Mobius_Game_Map2D.index(v.value0.mapEnv.value0.destinations)(new Mobius_Game_LatticePoint.LatticePoint(Mobius_Game_Surface.Back.value, i, j));
                                      if (v1 instanceof Data_Maybe.Just && (v1.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && v1.value0.value0)) {
                                          return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("destination")();
                                      };
                                      return Mobius_Game_Common.drawImagesFromImages(ctx)(images)("empty")();
  ...
  var move = function (v) {
      return function (d) {
          return MapEnv.create((function () {
              var v1 = Mobius_Game_Map2D.compute(Mobius_Game_Map2D.eqCell(Mobius_Game_Object.eqObject))(v.value0.map2D)(v.value0.character)(d);
              if (v1 instanceof Data_Maybe.Nothing) {
                  return {
                      map2D: v.value0.map2D,
                      character: v.value0.character,
                      destinations: v.value0.destinations
                  };
              };
              if (v1 instanceof Data_Maybe.Just) {
                  var v2 = Mobius_Game_Map2D.index(v.value0.map2D)(v1.value0);
                  if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof Mobius_Game_Map2D.SingularPoint) {
                      var nextPoint = Mobius_Game_LatticePoint.toPoint(v1.value0);
                      var doubleNextPoint = Mobius_Game_LatticePoint.computeWithPoint(nextPoint)(d);
                      var v3 = Mobius_Game_Map2D.indexWithPoint(v.value0.map2D)(doubleNextPoint);
                      if (v3 instanceof Data_Maybe.Just && (v3.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && (v3.value0.value0.value0 instanceof Mobius_Game_Map2D.Empty && v3.value0.value0.value1 instanceof Mobius_Game_Map2D.Empty))) {
                          var newMap2D = Mobius_Game_Map2D.moveSingularPoint(nextPoint)(d)(Mobius_Game_Map2D.Empty.value)(v.value0.map2D);
                          var newDestinations = Mobius_Game_Map2D.moveSingularPoint(nextPoint)(d)(false)(v.value0.destinations);
                          var v4 = Mobius_Game_Map2D.indexWithPoint(v.value0.destinations)(doubleNextPoint);
                          if (v4 instanceof Data_Maybe.Just && (v4.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && (!v4.value0.value0.value0 && !v4.value0.value0.value1))) {
                              return {
                                  map2D: newMap2D,
                                  character: v1.value0,
                  ...
                  if (v2 instanceof Data_Maybe.Just && (v2.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && v2.value0.value0 instanceof Mobius_Game_Map2D.Empty)) {
                      return {
                          map2D: v.value0.map2D,
                          character: v1.value0,
                          destinations: v.value0.destinations
                  ...
                  if (v2 instanceof Data_Maybe.Just && (v2.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && v2.value0.value0 instanceof Mobius_Game_Map2D["Object"])) {
                      var v3 = Mobius_Game_Object.objectProperty(v2.value0.value0.value0);
                      if (v3 instanceof Mobius_Game_Object.Stop) {
                          return {
                              map2D: v.value0.map2D,
                              character: v.value0.character,
                              destinations: v.value0.destinations
                      ...
                      if (v3 instanceof Mobius_Game_Object.Push) {
                          var v4 = Mobius_Game_Map2D.compute(Mobius_Game_Map2D.eqCell(Mobius_Game_Object.eqObject))(v.value0.map2D)(v1.value0)(d);
                          ...
                          if (v4 instanceof Data_Maybe.Just) {
                              var v5 = Mobius_Game_Map2D.index(v.value0.map2D)(v4.value0);
                              if (v5 instanceof Data_Maybe.Just && (v5.value0 instanceof Mobius_Game_Map2D.NotSingularPoint && v5.value0.value0 instanceof Mobius_Game_Map2D.Empty)) {
                                  var newMap2D = Mobius_Game_Map2D.updateAt(v4.value0)(new Mobius_Game_Map2D["Object"](v2.value0.value0.value0))(Mobius_Game_Map2D.updateAt(v1.value0)(Mobius_Game_Map2D.Empty.value)(v.value0.map2D));
                                  return {
                                      map2D: newMap2D,
                                      character: v1.value0,
                                      destinations: v.value0.destinations
                          ...
                          throw new Error("Failed pattern match at Mobius.Game.MapState (line 84, column 15 - line 91, column 50): " + [ v4.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Mobius.Game.MapState (line 82, column 43 - line 91, column 50): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return {
                          map2D: v.value0.map2D,
                  ...
                  throw new Error("Failed pattern match at Mobius.Game.MapState (line 68, column 19 - line 92, column 50): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Mobius.Game.MapState (line 66, column 63 - line 92, column 50): " + [ v1.constructor.name ]);
          })());
      };
  };
  var makeMapState = function (env) {
      return new MapState({
          mapEnv: env,
          history: [  ],
          initMap: env
  ...
  var updateState = function (v) {
      return function (i) {
          if (i instanceof Move) {
              return new MapState({
                  mapEnv: move(v.value0.mapEnv)(i.value0),
                  history: Data_Array.cons(v.value0.mapEnv)(v.value0.history),
                  initMap: v.value0.initMap
              });
          };
          if (i instanceof Z) {
              var v1 = Data_Array.uncons(v.value0.history);
              if (v1 instanceof Data_Maybe.Just) {
                  return new MapState({
                      mapEnv: v1.value0.head,
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                  return new MapState({
                      mapEnv: v.value0.mapEnv,
                      history: v.value0.history,
                      initMap: v.value0.initMap
                  });
              };
              throw new Error("Failed pattern match at Mobius.Game.MapState (line 51, column 8 - line 53, column 53): " + [ v1.constructor.name ]);
          };
          if (i instanceof R) {
              return makeMapState(v.value0.initMap);
          };
          throw new Error("Failed pattern match at Mobius.Game.MapState (line 49, column 57 - line 54, column 28): " + [ i.constructor.name ]);
      };
  };
  var isClear = function (v) {
      var w = Mobius_Game_Map2D.widthMap2D(v.value0.mapEnv.value0.map2D);
      var h = Mobius_Game_Map2D.heightMap2D(v.value0.mapEnv.value0.map2D);
      var allBox = Data_Array.filter(function (x) {
          return Data_Eq.eq(Data_Maybe.eqMaybe(Mobius_Game_Map2D.eqWithSingularPoint(Mobius_Game_Map2D.eqCell(Mobius_Game_Object.eqObject))))(Mobius_Game_Map2D.index(v.value0.mapEnv.value0.map2D)(x))(new Data_Maybe.Just(new Mobius_Game_Map2D.NotSingularPoint(new Mobius_Game_Map2D["Object"](Mobius_Game_Object.Box.value))));
      })(Control_Bind.bind(Control_Bind.bindArray)(Common.upRange(0)(h - 1 | 0))(function (i) {
          return Control_Bind.bind(Control_Bind.bindArray)(Common.upRange(0)(w - 1 | 0))(function (j) {
              return Control_Bind.bind(Control_Bind.bindArray)([ Mobius_Game_Surface.Front.value, Mobius_Game_Surface.Back.value ])(function (s) {
                  return Control_Applicative.pure(Control_Applicative.applicativeArray)(new Mobius_Game_LatticePoint.LatticePoint(s, i, j));
              });
          });
      }));
      return Data_Array.all(function (i) {
          return Data_Eq.eq(Data_Maybe.eqMaybe(Mobius_Game_Map2D.eqWithSingularPoint(Data_Eq.eqBoolean)))(Mobius_Game_Map2D.index(v.value0.mapEnv.value0.destinations)(i))(new Data_Maybe.Just(new Mobius_Game_Map2D.NotSingularPoint(true)));
      })(allBox);
  };
  ...
  exports["makeMapState"] = makeMapState;
  exports["updateState"] = updateState;
  exports["drawableMapState"] = drawableMapState;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Contents.Maps"] = $PS["Mobius.Contents.Maps"] || {};
  var exports = $PS["Mobius.Contents.Maps"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Matrix = $PS["Matrix"];
  var Mobius_Game_LatticePoint = $PS["Mobius.Game.LatticePoint"];
  var Mobius_Game_Map2D = $PS["Mobius.Game.Map2D"];
  var Mobius_Game_MapState = $PS["Mobius.Game.MapState"];
  var Mobius_Game_Object = $PS["Mobius.Game.Object"];
  var Mobius_Game_Surface = $PS["Mobius.Game.Surface"];                
  var w = new Mobius_Game_Map2D["Object"](Mobius_Game_Object.Wall.value);
  var t = true;
  var singu = Mobius_Game_Map2D.SingularPoint.value;
  var makeDoubledCell = function (x) {
      return function (y) {
          return Mobius_Game_Map2D.NotSingularPoint.create(new Data_Tuple.Tuple(x, y));
      };
  };
  var f = false;
  var e = Mobius_Game_Map2D.Empty.value;
  ...
  var testMapState = new Mobius_Game_MapState.MapEnv({
      character: new Mobius_Game_LatticePoint.LatticePoint(Mobius_Game_Surface.Front.value, 5, 3),
      destinations: Mobius_Game_Map2D.Map2D.create(Data_Maybe.fromMaybe(Matrix.empty)(Matrix.fromArray([ [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(t), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), singu, makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ] ]))),
      map2D: Mobius_Game_Map2D.Map2D.create(Data_Maybe.fromMaybe(Matrix.empty)(Matrix.fromArray([ [ makeDoubledCell(a)(e), makeDoubledCell(w)(w), makeDoubledCell(e)(e), makeDoubledCell(e)(w), makeDoubledCell(e)(e), makeDoubledCell(e)(e) ], [ makeDoubledCell(a)(e), makeDoubledCell(w)(w), makeDoubledCell(e)(e), makeDoubledCell(w)(w), makeDoubledCell(e)(e), makeDoubledCell(e)(e) ], [ makeDoubledCell(a)(e), makeDoubledCell(w)(e), makeDoubledCell(e)(a), makeDoubledCell(e)(e), makeDoubledCell(b)(e), makeDoubledCell(e)(e) ], [ makeDoubledCell(e)(e), makeDoubledCell(w)(w), singu, makeDoubledCell(w)(w), makeDoubledCell(w)(e), makeDoubledCell(e)(e) ], [ makeDoubledCell(e)(e), makeDoubledCell(e)(e), makeDoubledCell(e)(w), makeDoubledCell(e)(e), makeDoubledCell(e)(e), makeDoubledCell(e)(e) ], [ makeDoubledCell(e)(e), makeDoubledCell(e)(e), makeDoubledCell(e)(e), makeDoubledCell(e)(e), makeDoubledCell(e)(e), makeDoubledCell(e)(e) ] ])))
  });
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.Game.GameState"] = $PS["Mobius.Game.GameState"] || {};
  var exports = $PS["Mobius.Game.GameState"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect = $PS["Effect"];
  var Graphics_Canvas = $PS["Graphics.Canvas"];
  var Mobius_Contents_Maps = $PS["Mobius.Contents.Maps"];
  var Mobius_Game_Directions = $PS["Mobius.Game.Directions"];
  var Mobius_Game_Drawable = $PS["Mobius.Game.Drawable"];
  var Mobius_Game_GameManager = $PS["Mobius.Game.GameManager"];
  var Mobius_Game_MapState = $PS["Mobius.Game.MapState"];                
  var $$Map = (function () {
      function $$Map(value0) {
          this.value0 = value0;
  ...
  var drawableGameState = {
      draw: function (ctx) {
          return function (images) {
              return function (v) {
                  if (v.value0 instanceof Menu) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                  };
                  if (v.value0 instanceof $$Map) {
                      return Mobius_Game_Drawable.draw(Mobius_Game_MapState.drawableMapState)(ctx)(images)(v.value0.value0);
                  };
                  if (v.value0 instanceof Clear) {
                      return function __do() {
                          Mobius_Game_Drawable.draw(Mobius_Game_MapState.drawableMapState)(ctx)(images)(v.value0.value0)();
                          Graphics_Canvas.setFillStyle(ctx)("#999")();
                          return Graphics_Canvas.fillText(ctx)("Clear!")(20.0)(20.0)();
                      };
                  };
                  throw new Error("Failed pattern match at Mobius.Game.GameState (line 49, column 21 - line 55, column 38): " + [ v.constructor.name ]);
              };
          };
      }
  };
          ...
          if (v.value0 instanceof $$Map) {
              var nextMap = (function () {
                  if (v1 instanceof Move) {
                      return Mobius_Game_MapState.updateState(v.value0.value0)(new Mobius_Game_MapState.Move(v1.value0));
                  };
                  if (v1 instanceof Z) {
                      return Mobius_Game_MapState.updateState(v.value0.value0)(Mobius_Game_MapState.Z.value);
                  };
                  if (v1 instanceof R) {
                      return Mobius_Game_MapState.updateState(v.value0.value0)(Mobius_Game_MapState.R.value);
                  };
                  throw new Error("Failed pattern match at Mobius.Game.GameState (line 25, column 13 - line 28, column 47): " + [ v1.constructor.name ]);
              })();
              return GameState.create((function () {
                  var $16 = Mobius_Game_MapState.isClear(nextMap);
                  if ($16) {
                      return new Clear(nextMap);
                  };
  ...
  var strToInput = function (v) {
      if (v === "w") {
          return Data_Maybe.Just.create(new Move(Mobius_Game_Directions.Up.value));
      };
      if (v === "d") {
          return Data_Maybe.Just.create(new Move(Mobius_Game_Directions.Right.value));
      };
      if (v === "s") {
          return Data_Maybe.Just.create(new Move(Mobius_Game_Directions.Down.value));
      };
      if (v === "a") {
          return Data_Maybe.Just.create(new Move(Mobius_Game_Directions.Left.value));
      };
      if (v === "z") {
          return new Data_Maybe.Just(Z.value);
      };
      if (v === "r") {
  ...
  var keyHandler = function (k) {
      return function (state) {
          if (k.value1 instanceof Mobius_Game_GameManager.KeyDown) {
              var v = strToInput(k.value0);
              if (v instanceof Data_Maybe.Just) {
                  return updateState(state)(v.value0);
              };
              return state;
          };
          return state;
  ...
  var initGameState = GameState.create($$Map.create(Mobius_Game_MapState.makeMapState(Mobius_Contents_Maps.testMapState)));
  exports["keyHandler"] = keyHandler;
  exports["initGameState"] = initGameState;
  exports["drawableGameState"] = drawableGameState;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.WebApp.Components.Common"] = $PS["Mobius.WebApp.Components.Common"] || {};
  var exports = $PS["Mobius.WebApp.Components.Common"];
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Mobius.WebApp.Components.GameCanvas"] = $PS["Mobius.WebApp.Components.GameCanvas"] || {};
  var exports = $PS["Mobius.WebApp.Components.GameCanvas"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var Halogen_Hooks_Hook = $PS["Halogen.Hooks.Hook"];
  var Halogen_Hooks_HookM = $PS["Halogen.Hooks.HookM"];
  var Mobius_Game_Assets = $PS["Mobius.Game.Assets"];
  var Mobius_Game_Drawable = $PS["Mobius.Game.Drawable"];
  var Mobius_Game_GameManager = $PS["Mobius.Game.GameManager"];
  var Mobius_Game_GameSettings = $PS["Mobius.Game.GameSettings"];
  var Mobius_Game_GameState = $PS["Mobius.Game.GameState"];
  var Mobius_WebApp_Components_Common = $PS["Mobius.WebApp.Components.Common"];                
  var component = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Graphics_Canvas.getCanvasElementById("canvas")))(function (maybeCanvas) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                      if (maybeCanvas instanceof Data_Maybe.Just) {
                          return Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Mobius_Game_GameManager.runGame({
                              canvas: maybeCanvas.value0,
                              images: Mobius_Game_Assets.imageSources,
                              fps: 30,
                              initState: Mobius_Game_GameState.initGameState,
                              keyHandler: Mobius_Game_GameState.keyHandler,
                              render: Mobius_Game_Drawable.draw(Mobius_Game_GameState.drawableGameState),
                              height: Mobius_Game_GameSettings.canvasHeight,
                              width: Mobius_Game_GameSettings.canvasWidth
                          }));
                      };
                      ...
                      throw new Error("Failed pattern match at Mobius.WebApp.Components.GameCanvas (line 23, column 5 - line 30, column 27): " + [ maybeCanvas.constructor.name ]);
                  })())(function () {
...
(function($PS) {
  ...
  var Mobius_WebApp_Components_GameCanvas = $PS["Mobius.WebApp.Components.GameCanvas"];                
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("body"))(function (bodyElem) {
          return Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(Mobius_WebApp_Components_GameCanvas.component(Effect_Aff.monadEffectAff))(Data_Unit.unit))(bodyElem);
      });
  }));
  exports["main"] = main;
})(PS);
