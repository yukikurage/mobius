...
(function($PS) {
  ...
  var testMapState = new Mobius_Game_MapState.MapEnv({
      ...
      destinations: Mobius_Game_Map2D.Map2D.create(Data_Maybe.fromMaybe(Matrix.empty)(Matrix.fromArray([ [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), singu, makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(t)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ], [ makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f), makeDoubledCell(f)(f) ] ]))),
